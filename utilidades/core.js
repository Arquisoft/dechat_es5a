...
class SolidChessCore {
  ...
  /**
   * ESTE METODO PODRIA UTILIZARSE PARA OBTENER LOS CHATS QUE UN USUARIO PUEDE TENER ACTIVOS 
  ...
  /**
   * ESTE METODO PODRIA SERVIR PARA OBTENER LA URL DE DONDE GUARDAR LOS DATOS DE LAS CONVERSACIONES
  ...
  /**
   * ESTE METODO PODRIA SERVIR PARA OBTENER LOS MENSAJES
  ...
  /**
   * OBTENER EL PRIMER MENSAJE DE LA CHARLA
  ...
  /**
   * GENERA UNA URL UNICA PARA UN RECURSO
  ...
  /**
   * FORMATEA UN NOMBRE PARA CREAR LA CONEXION
  ...
  /**
   * OBTENER LAS CONVERSACIONES POSIBLES
  ...
  /**
   * OBTENER EL CHAT DE LA INVITACION
  ...
  /**
   * PROCESAR LA INVITACION A UN CHAT
